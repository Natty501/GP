...
<body class="bg-gray-50">
    ...
    <div>
        ...
        <p class="text-sm text-gray-600 mt-1">
            View any incident reports filed regarding your conduct
        </p>
    </div>

    <div class="flex items-center space-x-4">
        <!-- ADD INCIDENT BUTTON (OPEN MODAL) -->
...
<div id="incidentModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative">
        <!-- CLOSE BUTTON -->
        <button onclick="closeIncidentModal()" class="absolute top-3 right-3 text-gray-400 hover:text-gray-600">
        ...
        <form method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="location" required placeholder="e.g., Classroom 201, Cafeteria..."
                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" name="submit_incident"
