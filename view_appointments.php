        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <div class="bg-yellow-50 rounded-lg p-4">
            <div class="flex items-center space-x-2 mb-2">
              ...
              <span class="text-sm font-medium text-yellow-700">Guidance Service</span></div>
              
            <p class="text-yellow-800 font-semibold"><?= htmlspecialchars($row['guidance_services']) ?></p>
          </div>
        </div>
...
<div class="bg-indigo-50 rounded-lg p-4 mb-6">
  <div class="flex items-center space-x-2 mb-2">
    ...
    <span class="text-sm font-medium text-indigo-700">Teacher (Optional)</span>
  </div>
  <p class="text-indigo-800 font-semibold"><?= htmlspecialchars($row['teacher']) ?></p>
</div>
<?php endif; ?>
