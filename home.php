  ...
  <header class="bg-white/95 backdrop-blur-sm shadow-lg fixed top-0 left-0 w-full z-50">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
      ...
      <nav class="hidden md:flex space-x-8">
        ...
        <a href="index.php" class="hover:text-purple-600 transition-colors font-medium">Home</a>
        <a href="about.php" class="hover:text-purple-600 transition-colors font-medium">About</a>
        <a href="courses.php" class="hover:text-purple-600 transition-colors font-medium">Courses</a>
    ...
    <div id="mobileMenu" class="mobile-menu fixed top-0 left-0 w-full h-full bg-white z-40 md:hidden">
      <div class="flex flex-col p-6 space-y-6 mt-16">
        ...
        <a href="home.php" class="text-xl font-medium hover:text-purple-600 transition-colors">Home</a>
        <a href="about.php" class="text-xl font-medium hover:text-purple-600 transition-colors">About</a>
        <a href="courses.php" class="text-xl font-medium hover:text-purple-600 transition-colors">Courses</a>
        <a href="contact.php" class="text-xl font-medium hover:text-purple-600 transition-colors">Contact</a>
